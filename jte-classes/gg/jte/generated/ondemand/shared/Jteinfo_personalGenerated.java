...
public final class Jteinfo_personalGenerated {
	...
	public static final int[] JTE_LINE_INFO = {0,0,1,2,3,5,5,5,5,12,12,12,13,13,13,13,13,13,13,13,13,14,14,14,14,14,14,14,14,14,15,15,17,17,25,25,26,26,26,26,26,26,26,26,26,27,27,27,27,27,27,27,27,27,28,28,29,29,29,29,29,29,29,29,29,30,30,35,35,35,35,35,35,35,35,35,40,40,40,40,40,40,40,40,40,45,45,45,45,45,45,45,45,45,54,54,55,55,57,57,58,58,58,58,58,58,58,58,58,58,58,58,59,59,60,60,60,60,60,60,60,60,60,60,60,60,60,60,60,60,61,61,63,63,64,64,71,71,71,71,71,71,71,71,71,76,76,76,81,81,81,81,81,81,81,81,81,86,86,86,86,86,86,86,86,86,91,91,92,92,92,92,92,92,92,92,92,93,93,95,95,102,102,103,103,104,104,105,105,105,105,105,105,105,105,105,105,105,105,106,106,108,108,108,108,108,108,108,108,108,109,109,109,109,109,110,110,110,111,111,112,112,113,113,116,116,116,5,6,7,8,9,9,9,9};
		...
		for (var g : sexo) {
			...
			if (g.act()) {
				...
				if (!update) {
					...
					var __jte_html_attribute_10 = g.dat().equals(persona.getSexo().getDato());
		...
		for (var g : sangre) {
			...
			if (g.act()) {
				...
				if (!update) {
					...
					jteOutput.writeContent("\n                               ");
					var __jte_html_attribute_17 = g.dat().equals(persona.getTipo_sangre().getDato());
