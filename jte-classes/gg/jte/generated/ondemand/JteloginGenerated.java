...
public final class JteloginGenerated {
	...
	public static final int[] JTE_LINE_INFO = {0,0,0,0,0,15,15,15,15,15,15,15,15,15,17,17,17,17,17,17,37,37,37,46,46,46,46,46,46,46,46,46,49,49,49,57,57,57,57,57,57,57,57,57,60,60,60,62,62,64,64,64,66,66,67,67,69,69,69,71,71,75,78,78,78,93,93,93,0,1,2,3,3,3,3};
	public static void render(gg.jte.html.HtmlTemplateOutput jteOutput, gg.jte.html.HtmlInterceptor jteHtmlInterceptor, String error_msg, String success_msg, String app_nombre, abreuapps.core.control.utils.Localizer localize) {
		...
		jteOutput.writeUserContent(localize.apply("auth.login"));
		...
		var __jte_html_attribute_0 = localize.apply("auth.username");
		...
		jteOutput.writeUserContent(localize.apply("auth.username"));
		jteOutput.writeContent("</label>\n                                        </div>\n                                        <div class=\"form-floating mb-3\">\n                                            <input\n                                                class=\"form-control\"\n                                                id=\"password\"\n                                                name=\"password\"\n                                                type=\"password\"\n                                               ");
		var __jte_html_attribute_1 = localize.apply("auth.password");
		...
		jteOutput.setContext("label", null);
		jteOutput.writeUserContent(localize.apply("auth.password"));
		jteOutput.writeContent("</label>\n                                        </div>\n                                        ");
		if (error_msg != null) {
