...
//----------------------------------------------------------------------------//
    ...
    public String error(
        ...
        var statusCode = request.getAttribute(RequestDispatcher.ERROR_STATUS_CODE)==null ? null : Integer.valueOf(request.getAttribute(RequestDispatcher.ERROR_STATUS_CODE).toString());
        switch (statusCode){
            case 403 -> {
